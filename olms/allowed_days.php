...
<?php //	include ('add_modal_example_3.php'); ?>
                                <div class="x_content">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
							<?php
							$penalty_query= mysqli_query($dbcon,"select * from allowed_days order by allowed_days_id DESC ") or die (mysqli_error($dbcon));
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query2=mysqli_query($dbcon,"select * from allowed_days where allowed_days_id='$allowed_days_id'")or die(mysqli_error($dbcon));
												...
												<?php
													...
													{
														mysqli_query ($dbcon," UPDATE allowed_days SET no_of_days='$no_of_days1' ") or die (mysqli_error($dbcon));
													}
													{
