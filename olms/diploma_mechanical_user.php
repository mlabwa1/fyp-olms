<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							<a href="member_print_diploma_mechanical.php" target="_blank" style="background:none;">
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Members List</button>
							</a>
							<a href="print_barcode_diploma_mechanical.php" target="_blank" style="background:none;">
                    ...
                    <div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="active"><a href="diploma_mechanical_user.php">Mechanical Engineering</a></li>
                        </ul>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($dbcon,"select * from user where type='Diploma' and section='Mechanical Engineering' order by user_id DESC") or die (mysqli_error($dbcon));
