                ...
                <div class="x_panel">
                    ...
                    <div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="active"><a href="civil_user_first.php">4th Year</a></li>
                        </ul>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($dbcon,"SELECT * from user WHERE section='Civil' AND level='Fourth Year' order by user_id DESC") or die (mysqli_error($dbcon));
