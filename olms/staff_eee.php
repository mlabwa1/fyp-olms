<?php include ('header.php'); ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="member_print_staff_eee.php" target="_blank" style="background:none;">
                    <button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Members List</button>
                </a>
                <a href="print_barcode_staff_eee.php" target="_blank" style="background:none;">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="staff_eee.php">EEE</a></li>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <?php
                        $result= mysqli_query($dbcon,"select * from user where type='Staff' and section='EEE' order by user_id DESC") or die (mysqli_error($dbcon));
