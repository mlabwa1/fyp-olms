<?php include ('header.php'); ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="member_print_staff_education.php" target="_blank" style="background:none;">
                    <button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Members List</button>
                </a>
                <a href="print_barcode_staff_education.php" target="_blank" style="background:none;">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="staff_education.php">Education</a> </li>
                    <li role="presentation"><a href="staff_isne.php">ISNE</a></li>
                    <li role="presentation"><a href="staff_mechanical.php">Mechanical Engineering</a></li>
                </ul>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <?php
                        $result= mysqli_query($dbcon,"select * from user where type='Staff' and section='Education' order by user_id DESC") or die (mysqli_error($dbcon));
