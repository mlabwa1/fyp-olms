                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
							...
							<button class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Add Book</button>
							</a>
							</li>
                            <li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($dbcon,"select * from book order by book_id DESC ") or die (mysqli_error($dbcon));
							while ($row= mysqli_fetch_array ($result) ){
							$id=$row['book_id'];
							$category_id=$row['category_id'];

							$cat_query = mysqli_query($dbcon,"select * from category where category_id = '$category_id'")or die(mysqli_error($dbcon));
							...
							<tr>
								...
								<td style="word-wrap: break-word; width: 10em;"><?php echo $row['author']."<br />"."<br />"; ?></td>
