...
<div class = "container">
    <div id = "header">
        ...
        <p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Education-Computer Science Books List &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <div align="right">
        ...
        $result= mysqli_query($dbcon,"select * from book 
							...
							where classname ='Education - Computer Science'
