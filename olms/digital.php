            ...
            <div class="x_panel">
                ...
                <div class="x_title">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li role="presentation" class="active"><a href="digital.php">Soft Copies</a> </li>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            $result=mysqli_query($dbcon,"select * from book LEFT JOIN category ON book.category_id = category.category_id where classname='Soft'")or die(mysqli_error($dbcon));
                            while ($row= mysqli_fetch_array ($result) ){
                                $id=$row['book_id'];
                                $category_id=$row['category_id'];

                                $cat_query = mysqli_query($dbcon,"select * from category where classname = 'Soft'")or die(mysqli_error($dbcon));
