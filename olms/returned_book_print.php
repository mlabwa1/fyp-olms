...
include ('include/dbcon.php');
							...
							where return_book.date_returned BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59'  ")or die(mysqli_error($dbcon));
							$count_penalty_row = mysqli_fetch_array($count_penalty);
							
?>
						<table class="table table-striped">
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Date: From&nbsp;<?php include("timezone.php"); ?><?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y",strtotime($_SESSION['datefrom'])); ?> To&nbsp;<?php include("timezone.php"); ?><?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y",strtotime($_SESSION['dateto'])); ?></div></div>
                                </div>
								<br />
                                <div class="pull-left">
...
?>
							...
							<!---	<td style="text-transform: capitalize"><?php // echo $return_row['author']; ?></td>
								...
								<td style="text-align:center;"><?php include("timezone.php"); ?><?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y h:i:sa",strtotime($return_row['date_borrowed'])); ?></td>
                                <?php include("timezone.php"); ?><?php
