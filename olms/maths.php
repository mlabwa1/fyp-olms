<?php include ('header.php'); ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="book_print_education_maths.php" target="_blank" style="background:none;">
                    <button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Books List</button>
                </a>
                <a href="print_barcode_books_education_maths.php" target="_blank" style="background:none;">
                    <button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Books Barcode</button>
                </a>
                <br />
                <br />
                <div class="x_title">
                    <h2><i class="fa fa-book"></i> Books List/Education</h2>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li role="presentation"><a href="computer.php">Computer Science</a></li>
                        <li role="presentation"><a href="chemistry.php">Chemistry</a></li>
                        <li role="presentation"><a href="physics.php">Physics</a></li>
                        <li role="presentation"><a href="bios.php">Biology</a></li>
                        <li role="presentation" class="active"><a href="maths.php">Mathematics</a></li>
                        <!--li role="presentation"><a href="book.php">Back</a> </li>
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            $result=mysqli_query($dbcon,"select * from book LEFT JOIN category ON book.category_id = category.category_id where classname='Education - Mathematics'")or die(mysqli_error($dbcon));
                            while ($row= mysqli_fetch_array ($result) ){
                                $id=$row['book_id'];
                                $category_id=$row['category_id'];

                                $cat_query = mysqli_query($dbcon,"select * from category where classname = 'Education - Mathematics'")or die(mysqli_error($dbcon));
