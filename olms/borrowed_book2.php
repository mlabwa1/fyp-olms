                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<!--td><?php //date_default_timezone_set('Africa/Nairobi'); echo ($borrow_row['date_returned'] == "0000-00-00 00:00:00") ?ff "Pending" : date("M d, Y h:i:sa",strtotime($borrow_row['date_returned'])); ?></td-->
								<?php
