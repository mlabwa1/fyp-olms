<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							<a href="member_print_degree_civil.php" target="_blank" style="background:none;">
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Members List</button>
							</a>
							<a href="print_barcode_degree_civil.php" target="_blank" style="background:none;">
                    ...
                    <div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="active"><a href="degree_user.php">Degree</a></li>
                            <li role="presentation"><a href="diploma_user.php">Diploma</a></li>
                    ...
                    <div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            <li role="presentation"><a href="degree_user.php">All</a></li>
                            <li role="presentation"><a href="general_user.php">General Engineering</a></li>
                            <li role="presentation" class="active"><a href="civil_user.php">Civil Engineering</a></li>
                            <li role="presentation"><a href="cse_user.php">CSE</a></li>
                            <li role="presentation"><a href="ece_user.php">ECE</a></li>
                            <li role="presentation"><a href="eee_user.php">EEE</a></li>
                            <li role="presentation"><a href="education_user.php">Education</a> </li>
                            <li role="presentation"><a href="isne_user.php">ISNE</a></li>
                            <li role="presentation"><a href="mechanical_user.php">Mechanical Engineering</a></li>
                        </ul>
                    ...
                    <!--div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation"><a href="degree_user.php">2nd Year</a></li>
                            <li role="presentation"><a href="diploma_user.php">3rd Year</a></li>
                            <li role="presentation"><a href="civil_user_fourth.php">4th Year</a></li>
                        </ul>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($dbcon,"SELECT * from user WHERE type='Degree' and section='Civil' order by user_id DESC") or die (mysqli_error($dbcon));
