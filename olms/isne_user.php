<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							<a href="member_print_degree_isne.php" target="_blank" style="background:none;">
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Members List</button>
							</a>
							<a href="print_barcode_degree_isne.php" target="_blank" style="background:none;">
                    ...
                    <div class="clearfix"></div>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="active"><a href="isne_user.php">ISNE</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($dbcon,"select * from user where type='Degree' and section='ISNE' order by user_id DESC") or die (mysqli_error($dbcon));
