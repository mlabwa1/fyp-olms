...
?>
						<table class="table table-striped">
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Date: From&nbsp;<?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y",strtotime($_SESSION['datefrom'])); ?> To&nbsp;<?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y",strtotime($_SESSION['dateto'])); ?></div></div>
                                </div>
								<br />
						  <thead>
								<tr>
