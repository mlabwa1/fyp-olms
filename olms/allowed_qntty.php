...
<?php	// 	include ('add_modal_example.php'); ?>
                                <div class="x_content">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
							<?php
							$allowed_book_query= mysqli_query($dbcon,"select * from allowed_book order by allowed_book_id DESC ") or die (mysqli_error());
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query1=mysqli_query($dbcon,"select * from allowed_book where allowed_book_id='$id'")or die(mysqli_error());
												...
												<?php
													...
													{
														mysqli_query ($dbcon," UPDATE allowed_book SET qntty_books='$qntty_books' ") or die (mysqli_error($dbcon));
													}
													{
