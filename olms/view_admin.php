...
<?php
		...
		$id=$_GET['admin_id'];
		$result1 = mysqli_query($dbcon,"SELECT * FROM admin WHERE admin_id='$id'");
		...
		?>
							<tr>
								...
								<td><?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y h:i:s a", strtotime($row['admin_added'])); ?></td>
							</tr>
							<?php } ?>
							</tbody>
							</table>
