...
where date_log between '$sort 00:00:01' and '$sort 23:59:59' order by user_log.user_log_id DESC ") or die (mysqli_error($dbcon));
...
?>
							<tr>
								...
								<td style="text-align:center;"><?php include("timezone.php"); ?><?php date_default_timezone_set('Africa/Nairobi'); echo date("M d, Y h:i:s a", strtotime($row['date_log'])); ?></td>
							</tr>
				<?php }	} ?>					  
						  </tbody> 
					  </table> 
